...
model_file='D:/model/ZG111res.pth'
...
rmse=mean_squared_error(datas,pred_data)**0.5
r2=r2_score(datas,pred_data)
print(rmse)
print(r2)


t1=np.arange(len(datas))
plt.plot(datas[train_size:], color = 'black',label="real")
# 原数据
plt.plot(pred_data[train_size:], label="pred",color = 'y')
# 预测数据
plt.xlabel('Monitoring period /month')
plt.ylabel('res/mm')
# plt.savefig('D:/picture/DX01/res1.png')
plt.show()